 ...
 */
public class PlayListItemFragment extends Fragment implements Toolbar.OnMenuItemClickListener,
...
//            toggleQueueLock();
    ...
    private class QueueSwipeActions extends SwipeActions {
        ...
        public QueueSwipeActions() {
            super(ItemTouchHelper.UP | ItemTouchHelper.DOWN, PlayListItemFragment.this, TAG);
        }
