    ...
    private void exportLog() {
        try {
            ...
            try {
                ...
                i.setType("text/*");
                String authString = getString(de.danoeh.apexpod.core.R.string.provider_authority);
                ...
                String chooserTitle = getString(de.danoeh.apexpod.core.R.string.share_file_label);
