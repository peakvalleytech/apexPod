package de.danoeh.apexpod.view.viewholder;
...
import de.danoeh.apexpod.ui.common.CircularProgressBar;
...
public class EpisodeItemViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(FeedItem item, long autoPlayMode, long autoPlayListId) {
        this.item = item;
        ...
        ItemActionButton actionButton = ItemActionButton.forItem(item, autoPlayMode, autoPlayListId);
