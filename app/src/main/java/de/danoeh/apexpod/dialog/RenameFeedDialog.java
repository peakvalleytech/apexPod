...
public class RenameFeedDialog {
    ...
    public void show() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(activity)
                .setView(content)
                .setTitle(de.danoeh.apexpod.core.R.string.rename_feed_label)
                .setPositiveButton(android.R.string.ok, (d, input) -> {
                    feed.setCustomTitle(alertViewBinding.urlEditText.getText().toString());
                    DBWriter.setFeedCustomTitle(feed);
                })
                .setNeutralButton(de.danoeh.apexpod.core.R.string.reset, null)
                .setNegativeButton(de.danoeh.apexpod.core.R.string.cancel_label, null)
                .show();
