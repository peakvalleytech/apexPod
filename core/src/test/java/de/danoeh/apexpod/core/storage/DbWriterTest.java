...
public class DbWriterTest {
    ...
    @Test
    public void testSwapPrioritiesShouldPerformSwap() {
        Feed feed1 = new Feed();
        feed1.setId(0);
        FeedPreferences feed1_Prefs =
                new FeedPreferences(
                        1,
                        true,
                        true,
        ...
        long feed1_Priority = 5;
        long feed2_Priority = 10;
        feed1_Prefs.setPriority(feed1_Priority);
        feed2_Prefs.setPriority(feed2_Priority);
        feed1.setPreferences(feed1_Prefs);
        feed2.setPreferences(feed2_Prefs);
        DBWriter.setCompleteFeed(feed1, feed2);
        DBWriter.swapPriorities(feed1, feed2);
        Feed feed1Query = DBReader.getFeed(1);
        Feed feed2Query = DBReader.getFeed(2);
        FeedPreferences feed1ActualPrefs = feed1Query.getPreferences();
        FeedPreferences feed2ActualPrefs = feed2Query.getPreferences();
        assertEquals(feed2_Priority, feed1ActualPrefs.getPriority());
        assertEquals(feed1_Priority, feed2ActualPrefs.getPriority());
    }

    @Test
    public void testSwapPrioritiesShouldNotChangeOtherPrefs() {
        Feed feed1 = new Feed();
        feed1.setId(0);
        FeedPreferences feed1_Prefs =
                new FeedPreferences(
        ...
        long feed1_Priority = 5;
        long feed2_Priority = 10;
        long feed3_Priority = 15;
        feed1_Prefs.setPriority(feed1_Priority);
        feed2_Prefs.setPriority(feed2_Priority);
        feed3_Prefs.setPriority(feed3_Priority);
        feed1.setPreferences(feed1_Prefs);
        feed2.setPreferences(feed2_Prefs);
        feed3.setPreferences(feed3_Prefs);
        DBWriter.setCompleteFeed(feed1, feed2, feed3);
        DBWriter.swapPriorities(feed1, feed2);
        Feed feed1_Query = DBReader.getFeed(1);
        Feed feed2_Query = DBReader.getFeed(2);
        Feed feed3_Query = DBReader.getFeed(3);
        FeedPreferences feed1ActualPrefs = feed1_Query.getPreferences();
        FeedPreferences feed2ActualPrefs = feed2_Query.getPreferences();
        FeedPreferences feed3ActualPrefs = feed3_Query.getPreferences();
        assertEquals(feed2_Priority, feed1ActualPrefs.getPriority());
        assertEquals(feed1_Priority, feed2ActualPrefs.getPriority());
        assertEquals(feed3_Priority, feed3ActualPrefs.getPriority());
    }
