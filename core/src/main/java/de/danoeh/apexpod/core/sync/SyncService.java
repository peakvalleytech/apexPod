package de.danoeh.apexpod.core.sync;
...
import de.danoeh.apexpod.core.event.SyncServiceEvent;
...
import de.danoeh.apexpod.core.sync.queue.SynchronizationQueueStorage;
...
import de.danoeh.apexpod.net.sync.nextcloud.NextcloudSyncService;
...
public class SyncService extends Worker {
    ...
    private void updateErrorNotification(Exception exception) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(),
                R.id.pending_intent_sync_error, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
