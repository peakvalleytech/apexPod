...
public class SynchronizationCredentials {
    ...
    private static final String PREF_USERNAME = "de.danoeh.apexpod.preferences.gpoddernet.username";
    private static final String PREF_PASSWORD = "de.danoeh.apexpod.preferences.gpoddernet.password";
    private static final String PREF_DEVICEID = "de.danoeh.apexpod.preferences.gpoddernet.deviceID";
