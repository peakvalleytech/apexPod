...
public class PlayStatDBAdapter extends PodDBAdapter {
    private static final String TAG = "ApexDBAdapter";
    private static PlayStatDBAdapter instance;
    public static synchronized PlayStatDBAdapter getInstance() {
        if (instance == null) {
            instance = new PlayStatDBAdapter();
        }
        return instance;
    }
