...
public class MediaButtonReceiver extends BroadcastReceiver {
	...
	public static final String EXTRA_KEYCODE = "de.danoeh.apexpod.core.service.extra.MediaButtonReceiver.KEYCODE";
	public static final String EXTRA_SOURCE = "de.danoeh.apexpod.core.service.extra.MediaButtonReceiver.SOURCE";
	public static final String EXTRA_HARDWAREBUTTON = "de.danoeh.apexpod.core.service.extra.MediaButtonReceiver.HARDWAREBUTTON";

	public static final String NOTIFY_BUTTON_RECEIVER = "de.danoeh.apexpod.NOTIFY_BUTTON_RECEIVER";
