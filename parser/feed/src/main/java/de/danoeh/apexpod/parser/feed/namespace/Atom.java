package de.danoeh.apexpod.parser.feed.namespace;

import android.text.TextUtils;
import android.util.Log;

import de.danoeh.apexpod.model.feed.FeedFunding;
import de.danoeh.apexpod.parser.feed.HandlerState;
import de.danoeh.apexpod.parser.feed.element.AtomText;
import de.danoeh.apexpod.parser.feed.util.DateUtils;
import de.danoeh.apexpod.parser.feed.util.SyndStringUtils;
import org.xml.sax.Attributes;

import de.danoeh.apexpod.model.feed.FeedItem;
import de.danoeh.apexpod.model.feed.FeedMedia;
import de.danoeh.apexpod.parser.feed.element.SyndElement;
import de.danoeh.apexpod.parser.feed.util.SyndTypeUtils;
